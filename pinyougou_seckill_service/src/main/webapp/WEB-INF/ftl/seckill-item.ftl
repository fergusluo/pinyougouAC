        ...
        <div class="product-info">
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="news">
                    ...
                    <span class="overtime">{{allsecond}}距离结束：{{allsecondStr}}</span>
                </div>
                <div class="summary">
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a @click="submitOrder()" class="sui-btn  btn-danger addshopcar">{{btnSubmit}}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<script type="text/javascript">
    var app = new Vue({
        ...
        data:{
            ...
            allsecond:10,
            //结束时间
            endTimeStr:"${seckillGoods.endTime?string('yyyy-MM-dd HH:mm:ss')}",
            //总秒数格式化后的结果
            allsecondStr:"",
            //当前商品id
        ...
        methods: {
            startTimer:function () {
                ...
                //结束时间-毫秒
                let endTime = new Date(this.endTimeStr).getTime();
                //计算余下总秒数-Math.floor(取一个不要小数数的整数)
                this.allsecond = Math.floor((endTime - now) / 1000);*/
                ...
                let timer = window.setInterval(function () {
                    app.allsecond--;
                    //把秒格式化
                    app.allsecondStr = app.convertTimeString(app.allsecond);
                    if(app.allsecond < 1){
                        //停止计时
